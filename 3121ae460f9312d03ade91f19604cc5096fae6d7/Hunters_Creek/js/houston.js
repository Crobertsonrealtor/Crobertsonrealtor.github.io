...
map.on("load", function() {
  ...
  map.addLayer({
    ...
    map.addLayer({
      ...
      geometry: {
      type: "Point",
      coordinates: [-95.499569, 29.781060]
      }
      }
      ]
      }
...
map.on('mouseenter', 'baseCamp', function (e) {
  ...
  popup
    ...
    + "<img src=\"images/trail1.png\" width=\"200px\" height=\"150px\">" + "<br>" + "Trails of Hunters Creek Village" 
...
map.on('mouseenter', 'camp2', function (e) {
  ...
  popup
    .setLngLat(coordinates)
    .setHTML("<img src=\"images/logo.jpg\" width=\"100px\" height=\"100px\">" + "Hunters Creek Village" + "<br>" 
    + "<img src=\"images/trail2_1.png\" width=\"200px\" height=\"150px\">" + "<br>" + "Trails of Hunters Creek Village" 
    + "<br>" + "<img src=\"images/trail.png\">" + "Trail Location" + "<br>" 
...
map.on('mouseenter', 'camp3', function (e) {
  ...
  popup
    .setLngLat(coordinates)
    .setHTML("<img src=\"images/logo.jpg\" width=\"100px\" height=\"100px\">" + "Hunters Creek Village" + "<br>" 
    + "<img src=\"images/trail2_2.png\" width=\"200px\" height=\"150px\">" + "<br>" + "Trails of Hunters Creek Village" 
    + "<br>" + "<img src=\"images/trail.png\">" + "Trail Location" + "<br>" 
...
map.on('mouseenter', 'camp4', function (e) {
  ...
  popup
    ...
    + "<br>" + "<img src=\"images/trail.png\">" + "Trail Location" + "<br>" 
    + "PRIVATE PROPERTY: Connects Timberglen Dr to Caruthers Ln")
    .addTo(map);
...
map.on('mouseenter', 'camp5', function (e) {
  ...
  popup
    ...
    + "<img src=\"images/trail3.png\" width=\"200px\" height=\"150px\">" + "<br>" + "Trails of Hunters Creek Village" 
    + "<br>" + "<img src=\"images/trail.png\">" + "Trail Location" + "<br>" 
    + "PRIVATE PROPERTY: Connects Caruthers Ln to Timberglen Dr")
    .addTo(map);
...
map.on('mouseenter', 'camp6', function (e) {
  ...
  popup
    .setLngLat(coordinates)
    .setHTML("<img src=\"images/logo.jpg\" width=\"100px\" height=\"100px\">" + "Hunters Creek Village" + "<br>" 
    + "<img src=\"images/trail4_1.png\" width=\"200px\" height=\"150px\">" + "<br>" + "Trails of Hunters Creek Village" 
    + "<br>" + "<img src=\"images/trail.png\">" + "Trail Location" + "<br>" 
...
map.on('mouseenter', 'camp7', function (e) {
  ...
  popup
    .setLngLat(coordinates)
    .setHTML("<img src=\"images/logo.jpg\" width=\"100px\" height=\"100px\">" + "Hunters Creek Village" + "<br>" 
    + "<img src=\"images/trail4_2.png\" width=\"200px\" height=\"150px\">" + "<br>" + "Trails of Hunters Creek Village" 
    + "<br>" + "<img src=\"images/trail.png\">" + "Trail Location" + "<br>" 
...
var route4 = {
  ...
  "geometry": {
  "type": "LineString",
  "coordinates": [[-95.499569, 29.781060], [-95.499554, 29.780531], [-95.499423, 29.780452]]
  }
  }]
};
